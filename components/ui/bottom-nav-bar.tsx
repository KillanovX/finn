...
const navItems = [
  ...
  { label: "Transações", icon: CreditCard, href: "/transacoes" },
  { label: "Orçamentos", icon: MessageCircle, href: "/orcamentos" },
  { label: "Metas", icon: Trophy, href: "/metas" },
