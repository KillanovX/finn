...
export function SummaryCards() {
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="relative flex flex-col justify-between overflow-hidden rounded-3xl bg-primary p-5 text-primary-foreground sm:col-span-2 lg:col-span-1 min-h-[156px]">
        ...
        <div className="my-2 flex h-9 items-center text-3xl font-semibold tracking-tight">
          <AnimatedAmount value={formatCurrency(totalBalance)} isVisible={isBalanceVisible} />
        </div>
        <div className="inline-flex items-center gap-1 rounded-full bg-primary-foreground/10 px-2 py-1 text-xs w-fit">
      ...
      {/* Receitas — card lima */}
      <div className="flex flex-col justify-between rounded-3xl bg-accent p-5 text-accent-foreground min-h-[156px]">
        <div className="flex items-center justify-between">
        ...
        <p className="text-xs text-accent-foreground/70">Entradas confirmadas</p>
      </div>

      {/* Despesas */}
      <div className="flex flex-col justify-between rounded-3xl bg-card p-5 text-card-foreground min-h-[156px]">
        <div className="flex items-center justify-between">
        ...
        <p className="text-xs text-muted-foreground">63% da sua renda</p>
      </div>
