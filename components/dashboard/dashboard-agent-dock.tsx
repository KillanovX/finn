...
export function DashboardAgentDock() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 w-full max-w-[calc(100vw-3rem)] sm:max-w-md">
      {/* Response Card Popup */}
      {response && (
        <div className="relative w-full overflow-hidden rounded-2xl bg-neutral-950/95 border border-neutral-800 p-4 text-white shadow-2xl backdrop-blur-md transition-all animate-in fade-in slide-in-from-bottom-2">
          <div className="flex items-center justify-between pb-2 mb-2 border-b border-neutral-800">
            <div className="flex items-center gap-1.5 text-xs font-semibold text-neutral-300">
              ...
              <span>Zara · NVIDIA Nemotron-70B</span>
            </div>
            <button
      ...
      <AgentDock
        ...
        idleStatus="Sua assistente (NVIDIA Nemotron)"
        workingStatus="Consultando Nemotron 70B..."
